    ...
    def create
      ...
      unless session_record.gym == current_gym
        redirect_to storefront_session_path(session_record, gym_slug: session_record.gym.slug),
                    alert: I18n.t('storefront.bookings.wrong_gym', default: 'Deze boeking hoort bij een andere locatie.')
        return
      end
      ...
      redirect_to storefront_session_path(session_record, gym_slug: session_record.gym.slug), alert: e.message
    end
